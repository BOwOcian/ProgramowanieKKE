...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Services\\TestCalculator' => 'getTestCalculatorService',
            'App\\Twig\\Components\\LikeComponent' => 'getLikeComponentService',
            'App\\Twig\\Components\\SearchComponent' => 'getSearchComponentService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('2kC0JwbgS2', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('66Z60aEZ8E', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bBOFXoJ3SA', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['url' => $this->getEnv('resolve:DATABASE_URL'), 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driverOptions' => [], 'serverVersion' => 5.6, 'defaultTableOptions' => []], $a, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\EventListener\\NewPostListener' => ['privates', 'App\\EventListener\\NewPostListener', 'getNewPostListenerService', true],
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.request', [0 => #[\Closure(name: 'ux.live_component.event_subscriber', class: 'Symfony\\UX\\LiveComponent\\EventListener\\LiveComponentSubscriber')] function () {
            return ($this->privates['ux.live_component.event_subscriber'] ?? $this->getUx_LiveComponent_EventSubscriberService());
        }, 1 => 'onKernelRequest'], 0);
        $instance->addListener('kernel.controller', [0 => #[\Closure(name: 'ux.live_component.event_subscriber', class: 'Symfony\\UX\\LiveComponent\\EventListener\\LiveComponentSubscriber')] function () {
            return ($this->privates['ux.live_component.event_subscriber'] ?? $this->getUx_LiveComponent_EventSubscriberService());
        }, 1 => 'onKernelController'], 0);
        $instance->addListener('kernel.view', [0 => #[\Closure(name: 'ux.live_component.event_subscriber', class: 'Symfony\\UX\\LiveComponent\\EventListener\\LiveComponentSubscriber')] function () {
            return ($this->privates['ux.live_component.event_subscriber'] ?? $this->getUx_LiveComponent_EventSubscriberService());
        }, 1 => 'onKernelView'], 0);
        $instance->addListener('kernel.response', [0 => #[\Closure(name: 'ux.live_component.event_subscriber', class: 'Symfony\\UX\\LiveComponent\\EventListener\\LiveComponentSubscriber')] function () {
            return ($this->privates['ux.live_component.event_subscriber'] ?? $this->getUx_LiveComponent_EventSubscriberService());
        }, 1 => 'onKernelResponse'], 0);
        $instance->addListener('kernel.exception', [0 => #[\Closure(name: 'ux.live_component.event_subscriber', class: 'Symfony\\UX\\LiveComponent\\EventListener\\LiveComponentSubscriber')] function () {
            return ($this->privates['ux.live_component.event_subscriber'] ?? $this->getUx_LiveComponent_EventSubscriberService());
        }, 1 => 'onKernelException'], 20);
        $instance->addListener('Symfony\\UX\\TwigComponent\\Event\\PreCreateForRenderEvent', [0 => #[\Closure(name: 'ux.live_component.intercept_child_component_render_subscriber', class: 'Symfony\\UX\\LiveComponent\\EventListener\\InterceptChildComponentRenderSubscriber')] function () {
        ...
        $instance->addListener('Symfony\\UX\\TwigComponent\\Event\\PostRenderEvent', [0 => #[\Closure(name: 'ux.live_component.reset_deterministic_id_subscriber', class: 'Symfony\\UX\\LiveComponent\\EventListener\\ResetDeterministicIdSubscriber')] function () {
        ...
        $instance->addListener('Symfony\\UX\\TwigComponent\\Event\\PreRenderEvent', [0 => #[\Closure(name: 'ux.live_component.add_attributes_subscriber', class: 'Symfony\\UX\\LiveComponent\\EventListener\\AddLiveAttributesSubscriber')] function () {
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('8mSqTGSYb1', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('O2FWBLgrGj', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TBMK29DD+o', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Yf-PsTJSzN', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('I4qMo-jz8M', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('97b8aYQVNa', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDebug_Security_Access_DecisionManagerService()
    {
        return $this->privates['debug.security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\TraceableAccessDecisionManager(new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () {
            ...
            yield 3 => ($this->privates['debug.security.voter.App\\Security\\Voter\\PostVoter'] ?? $this->load('getPostVoterService'));
    ...
    {
        return $this->privates['knp_paginator.subscriber.sliding_pagination'] = new \Knp\Bundle\PaginatorBundle\Subscriber\SlidingPaginationSubscriber(['defaultPaginationTemplate' => '@KnpPaginator/Pagination/tailwindcss_pagination.html.twig', 'defaultSortableTemplate' => '@KnpPaginator/Pagination/sortable_link.html.twig', 'defaultFiltrationTemplate' => '@KnpPaginator/Pagination/filtration.html.twig', 'defaultPageRange' => 5, 'defaultPageLimit' => NULL]);
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'knp_paginator.template.pagination' => '@KnpPaginator/Pagination/tailwindcss_pagination.html.twig',
