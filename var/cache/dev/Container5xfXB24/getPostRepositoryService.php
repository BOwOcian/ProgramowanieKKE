...
class getPostRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['App\\Repository\\PostRepository'])) {
            return $container->privates['App\\Repository\\PostRepository'];
        }

        return $container->privates['App\\Repository\\PostRepository'] = new \App\Repository\PostRepository(($container->services['doctrine'] ?? $container->getDoctrineService()), $a);
    }
}
